...
<body>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Kelola Pemasok</li>
                </ul>
            </div>
            ...
            <div class="page-content">
                <div class="row-fluid">
                    ...
                    <a href="<?php echo base_url() ?>index.php/pemasok/cetak" target="_blank" role="button" class="btn btn-yellow">
                        Cetak PDF</a>
                    ...
                    <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($data_pemasok as $row) { ?>
                                <tr class="odd">
                                    <td class="center"><?= $no; ?></td>
                                    <td class="center"><?= $row->no_pemasok ?></td>
                                    ...
                                    <td class="td-actions">
                                        <div class="hidden-phone visible-desktop action-buttons">
                                            <a class="green btn_edit" title="Edit Data" href="#"
                                                data-no_pemasok="<?php echo $row->no_pemasok;?>"
                                                data-nama_pemasok="<?php echo $row->nama_pemasok;?>"
    ...
    <!-- FORM MODAL -->
    <form name="modal_form1" method="post" action="<?php echo base_url(); ?>pemasok/simpan" enctype="multipart/form-data">
        <div id="modal-form" class="modal hide" tabindex="-1">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Tambah Pemasok</h4>
            </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span7">
                        <div class="control-group">
                            <label class="control-label" for="no_pemasok">No Pemasok</label>
                            <div class="controls">
                                <input type="text" class="span5" name="no_pemasok" id="no_pemasok"
                                    value="<?php echo $nomor_otomatis ?>" readonly />
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" for="nama_pemasok">Nama Pemasok</label>
                            <div class="controls">
                                <input type="text" class="span12" name="nama_pemasok" id="nama_pemasok" />
                            </div>
                        </div>
    ...
    <form name="modal_form2" method="post" action="<?php echo base_url(); ?>pemasok/ubah" enctype="multipart/form-data">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span7">
                        <div class="control-group">
                            <label class="control-label" for="no_pemasok">No Pemasok</label>
                            <div class="controls">
                                <input type="text" class="span5 no_pemasok" name="no_pemasok_edit" id="no_pemasok"
                                    value="" readonly />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="nama_pemasok">Nama Pemasok</label>
                            <div class="controls">
                                <input type="text" class="span12 nama_pemasok" name="nama_pemasok_edit" id="nama_pemasok" placeholder="Nama Pemasok"/>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        $('.btn_hapus').on('click', function () {
            const no_pemasok   = $(this).data('no_pemasok');
            const nama_pemasok = $(this).data('nama_pemasok');
            bootbox.confirm(
                nama_pemasok + " akan dihapus?",
                function (result) {
                    if (result) {
                        window.location.href =
                            "<?= base_url(); ?>index.php/pemasok/hapus/" + no_pemasok;
                    }
                }
            );
        });
    ...
    <script>
        function cek_inputan(){
            if (document.modal_form1.nama_pemasok.value === ""){
                document.modal_form1.nama_pemasok.focus();
                alert("Maaf Nama Pemasok masing kosong");
                return(false);
            }
    ...
    <script>
        function cek_inputan_edit(){
            if (document.modal_form2.nama_pemasok_edit.value === ""){
                document.modal_form2.nama_pemasok_edit.focus();
                alert("Maaf Nama Pemasok masih kosong");
                return false;
            }
        }
    </script>
