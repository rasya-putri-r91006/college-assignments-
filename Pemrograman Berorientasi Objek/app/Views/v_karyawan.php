...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row-fluid">
                    ...
                    <a href="<?php echo base_url() ?>index.php/karyawan/cetak" target="_blank" role="button" class="btn btn-yellow">
                        Cetak PDF</a>
                    ...
                    <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($data_karyawan as $row) { ?>
                                <tr class="odd">
                                    <td class="center"><?= $no; ?></td>
                                    <td class="center"><?= $row->no_karyawan ?></td>
                                    ...
                                    <td class="td-actions">
                                        <div class="hidden-phone visible-desktop action-buttons">
                                            <a class="green btn_edit" title="Edit Data" href="#"
                                                data-no_karyawan="<?php echo $row->no_karyawan;?>"
    ...
    <!-- FORM MODAL -->
    <form name="modal_form1" method="post" action="<?php echo base_url(); ?>karyawan/simpan" enctype="multipart/form-data">
        <div id="modal-form" class="modal hide" tabindex="-1">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Tambah Karyawan</h4>
            </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span7">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span5" name="no_karyawan" id="no_karyawan"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span12" name="nama_karyawan" id="nama_karyawan" />
                            </div>
                        </div>
    ...
    <form name="modal_form2" method="post" action="<?php echo base_url(); ?>karyawan/ubah" enctype="multipart/form-data">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span7">
                        <div class="control-group">
                            <label class="control-label" for="no_karyawan">No Karyawan</label>
                            <div class="controls">
                                <input type="text" class="span5 no_karyawan" name="no_karyawan_edit" id="no_karyawan"
                                    value="" readonly />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="nama_karyawan">Nama Karyawan</label>
                            <div class="controls">
                                <input type="text" class="span12 nama_karyawan" name="nama_karyawan_edit" id="nama_karyawan" placeholder="Nama Karyawan"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="password">Password</label>
                            <div class="controls">
                                <input type="password" class="span6" name="password_edit" id="password" />
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('.btn_hapus').on('click', function () {
            ...
            bootbox.confirm(
                nama_karyawan + " akan dihapus?",
                function (result) {
                    if (result) {
                        window.location.href =
                            "<?= base_url(); ?>index.php/karyawan/hapus/" + no_karyawan;
                    }
                }
            );
        });
    ...
    <script>
        function cek_inputan_edit(){
            if (document.modal_form2.nama_karyawan_edit.value === ""){
                ...
                alert("Maaf Nama Karyawan masih kosong");
                return false;
            }
        }
    </script>
