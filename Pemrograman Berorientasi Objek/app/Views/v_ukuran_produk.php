...
<body>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Kelola Ukuran Produk</li>
                </ul>
            </div>
            ...
            <div class="page-content">
                <div class="row-fluid">
                    ...
                    <a href="<?php echo base_url() ?>index.php/ukuran_produk/cetak" target="_blank" role="button" class="btn btn-yellow">
                        Cetak PDF</a>
                    ...
                    <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($data_ukuran_produk as $row) { ?>
                                <tr class="odd">
                                    <td class="center"><?= $no; ?></td>
                                    <td class="center"><?= $row->no_ukuran_produk ?></td>
                                    <td class="center"><?= $row->nama_ukuran_produk ?></td>
                                    </td>

                                    <td class="td-actions">
                                        <div class="hidden-phone visible-desktop action-buttons">
                                            <a class="green btn_edit" title="Edit Data" href="#"
                                                data-no_ukuran_produk="<?php echo $row->no_ukuran_produk;?>"
    ...
    <!-- FORM MODAL -->
    <form name="modal_form1" method="post" action="<?php echo base_url(); ?>ukuran_produk/simpan">
        <div id="modal-form" class="modal hide" tabindex="-1">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Tambah Ukuran Produk</h4>
            </div>
                    <div class="span5">
                        <div class="control-group">
                            <label class="control-label" for="no_ukuran_produk">No Ukuran Produk</label>
                            <div class="controls">
                                <input type="text" class="span5" name="no_ukuran_produk" id="no_ukuran_produk"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span5" name="nama_ukuran_produk" id="nama_ukuran_produk" />
                            </div>
    ...
    <form name="modal_form2" method="post" action="<?php echo base_url(); ?>ukuran_produk/ubah">
                ...
                <h4 class="blue bigger">Edit Data</h4>
                    ...
                    <div class="span5">
                        <div class="control-group">
                            <label class="control-label" for="no_ukuran_produk">No Ukuran Produk</label>
                            <div class="controls">
                                <input type="text" class="span5 no_ukuran_produk" name="no_ukuran_produk_edit" id="no_ukuran_produk"
                                    value="" readonly />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="nama_ukuran_produk">Nama Ukuran Produk</label>
                            <div class="controls">
                                <input type="text" class="span5 nama_ukuran_produk" name="nama_ukuran_produk_edit" id="nama_ukuran_produk" placeholder="Nama Ukuran Produk"/>
                            </div>
...
<script>
    $(document).ready(function () {
        $('.btn_hapus').on('click', function () {
            ...
            bootbox.confirm(
                nama_ukuran_produk + " akan dihapus?",
                function (result) {
                    if (result) {
                        window.location.href =
                            "<?= base_url(); ?>index.php/ukuran_produk/hapus/" + no_ukuran_produk;
                    }
                }
            );
        });
    ...
    <script>
        function cek_inputan(){
            ...
            if (document.modal_form1.no_ukuran_produk.value === ""){
                ...
                alert("Maaf No Ukuran Produk masih kosong");
                return(false);
            }
        }
    </script>
