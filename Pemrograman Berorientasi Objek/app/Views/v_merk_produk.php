...
<body>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Kelola Merk Produk</li>
                </ul>
            </div>
            ...
            <div class="page-content">
                <div class="row-fluid">
                    ...
                    <a href="<?php echo base_url() ?>index.php/merk_produk/cetak" target="_blank" role="button" class="btn btn-yellow">
                        Cetak PDF</a>
                    ...
                    <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($data_merk_produk as $row) { ?>
                                <tr class="odd">
                                    <td class="center"><?= $no; ?></td>
                                    <td class="center"><?= $row->no_merk_produk ?></td>
                                    <td class="center"><?= $row->nama_merk_produk ?></td>
                                    </td>

                                    <td class="td-actions">
                                        <div class="hidden-phone visible-desktop action-buttons">
                                            <a class="green btn_edit" title="Edit Data" href="#"
                                                data-no_merk_produk="<?php echo $row->no_merk_produk;?>"
    ...
    <!-- FORM MODAL -->
    <form name="modal_form1" method="post" action="<?php echo base_url(); ?>merk_produk/simpan">
        <div id="modal-form" class="modal hide" tabindex="-1">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Tambah Merk Produk</h4>
            </div>
                    <div class="span5">
                        <div class="control-group">
                            <label class="control-label" for="no_merk_produk">No Merk Produk</label>
                            <div class="controls">
                                <input type="text" class="span5" name="no_merk_produk" id="no_merk_produk"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span5" name="nama_merk_produk" id="nama_merk_produk" />
                            </div>
    ...
    <form name="modal_form2" method="post" action="<?php echo base_url(); ?>merk_produk/ubah">
                ...
                <h4 class="blue bigger">Edit Data</h4>
                    ...
                    <div class="span5">
                        <div class="control-group">
                            <label class="control-label" for="no_merk_produk">No Merk Produk</label>
                            <div class="controls">
                                <input type="text" class="span5 no_merk_produk" name="no_merk_produk_edit" id="no_merk_produk"
                                    value="" readonly />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="nama_merk_produk">Nama Merk Produk</label>
                            <div class="controls">
                                <input type="text" class="span5 nama_merk_produk" name="nama_merk_produk_edit" id="nama_merk_produk" placeholder="Nama Merk Produk"/>
                            </div>
...
<script>
    $(document).ready(function () {
        $('.btn_hapus').on('click', function () {
            ...
            bootbox.confirm(
                nama_merk_produk + " akan dihapus?",
                function (result) {
                    if (result) {
                        window.location.href =
                            "<?= base_url(); ?>index.php/merk_produk/hapus/" + no_merk_produk;
                    }
                }
            );
        });
    ...
    <script>
        function cek_inputan(){
            ...
            if (document.modal_form1.no_merk_produk.value === ""){
                ...
                alert("Maaf No Merk Produk masih kosong");
                return(false);
            }
        }
    </script>
